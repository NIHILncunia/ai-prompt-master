...
### 2026-09-08-daily-git-repository-automation

- 작업명: 매일 23시 두 Git 저장소 자동 관리
- 상태: 완료
- 작업 유형: Codex 예약 작업 설계
- 시작일: 2026-09-08
- 완료일: 2026-09-08
- 설계: `specs/2026-09-08-daily-git-repository-automation-design.md`
- 실행 계획: `plans/2026-09-08-daily-git-repository-automation.md`
- 검증 보고서: `reports/2026-09-08-daily-git-repository-automation-verification.md`
- 자동화 식별자: `23-git`
- 대상 저장소: `C:\Users\nihil\coding\note\project-yggdrail-codex`, `C:\Users\nihil\coding\ai\ai-data-master`
- 목표: 두 Git 루트의 모든 현재 변경을 안전 검사 뒤 논리적인 단위로 커밋하고 현재 upstream으로 push한다.
- 실행 기준: 매일 23:00 KST, `gpt-5.6-sol`, 추론 수준 `high`, 저장소별 실패 격리.
- 결과: 자동화 `23-git`을 활성화하고 두 저장소 `master`의 upstream을 `origin/master`로 확인했다. 정적 설정과 중복 여부를 검증했으며 실제 실행 결과는 첫 예약 실행에서 확인한다.

### 2026-08-21-luxterra-federation-notice-system

- 작업명: 자유 탐사 연맹 공고 체계 개편
- 상태: 완료
- 작업 유형: 룩스테라 공개 공고 분류·문서 경계 개편
- 시작일: 2026-08-21
- 설계: `specs/2026-08-21-luxterra-federation-notice-system-design.md`
- 실행 계획: `plans/2026-08-22-luxterra-federation-notice-system.md`
- 대상 정본: `../../룩스테라/설정/주요 개념/자유 탐사 연맹 공고 체계.md`, `../../룩스테라/설정/주요 개념/자유 탐사 연맹 문명권·앙그라 공고.md`, `../../룩스테라/설정/주요 개념/라크샤라 현지 활동 공고.md`, `../../룩스테라/설정/개념/모험가.md`
- 목표: 공개 공고를 해결사·개척자·사냥꾼 중심으로 재분류하고, 공통 체계·본토 공고·라크샤라 공고의 문서 책임을 분리한다.
- 현재 결정: 모든 공고 공개, 위험 개체 여섯 등급, 변이체·재해룡종 용어 분리, 세계수의 적 다섯 형태와 적대 성격 도입, 안개 사안의 개척자 우선 배정.
- 완료 결과: 공통 체계 35개, 본토 21개, 라크샤라 42개로 총 98개 세부 공고를 반영하고 모험가·오리진의 공개 참조를 갱신했다.
- 미결: 세계수의 적 형태별 공고 35개와 라크샤라 신규·보강 공고 17개의 최종 명칭.
...
### 2026-09-06-work-folder-routing-migration

- 작업명: 작업 폴더 경로 및 ID 전환
- 상태: 완료
- 작업 유형: 프로젝트 공통 라우팅 지침 정비
- 시작일: 2026-09-06
- 완료일: 2026-09-07
- 설계: `specs/2026-09-06-work-folder-routing-migration-design.md`
- 실행 계획: `plans/2026-09-06-work-folder-routing-migration.md`
- 검증 보고서: `reports/2026-09-07-work-folder-routing-migration-verification.md`
- 대표 정비 문서: `../../설정 정비/작업 폴더 경로 및 ID 전환 정비.md`
- 결과: 신규 작업 저장소 활성 지침 9개, 설정 활성 지침 5개, 사용자 전역 지침 1개를 신규 ID와 Git 로컬 경로로 전환하고 메모리 수정 요청을 등록했다.
